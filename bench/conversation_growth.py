...
def _run_turn(
    ...
    return {
        ...
        "content_payload_bytes": publication.content_payload_bytes,
        "projection_bytes_reclaimed": publication.projection_bytes_reclaimed,
        "inherited_tensor_bytes": publication.inherited_tensor_bytes,
        "novel_tensor_bytes": publication.novel_tensor_bytes,
